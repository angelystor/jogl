//COPIED from gl-impl-CustomJavaCode-desktop


    /** Helper for more precise computation of number of bytes that will
        be touched by a pixel pack or unpack operation. */
    private static int imageSizeInBytes(int bytesPerElement,
                                 int width, int height, int depth, boolean pack) {
        //shifted this from private instance variable to mtd local
        //it doesn't seem to be used by any other method and the contents it'll store as
        //an instance var doesn't seem used
        int[] imageSizeTemp = new int[1];                                 
